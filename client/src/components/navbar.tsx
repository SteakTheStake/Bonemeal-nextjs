...
export function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/60 backdrop-blur-xl transition-colors duration-300">
          ...
          <div className="flex items-center gap-3">
            ...
            {isLoading ? (
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent className="w-56 bg-background/95 backdrop-blur-xl border-border/40" align="end">
                  <div className="flex items-center justify-start gap-2 p-2">
                    <Avatar className="h-8 w-8">
                      <AvatarImage 
                        ...
                        alt={user.username} 
                      />
                      <AvatarFallback className="bg-muted text-foreground">{user.username?.charAt(0).toUpperCase()}</AvatarFallback>
                    </Avatar>
                  ...
                  <DropdownMenuItem className="text-muted-foreground hover:text-foreground hover:bg-accent/20">
              ...
              <Button
                ...
                className="bg-[#5865F2] hover:bg-[#4752C4] text-white gap-1 sm:gap-2 transition-colors duration-200 px-2 sm:px-4"
                size="sm"
              >
                <svg className="h-4 w-4 sm:h-5 sm:w-5" viewBox="0 0 71 55" fill="none">
